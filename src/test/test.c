...
// Round down tests
PASS_SETUP(float_round_down1, "36028797018963970.0", 64)
	CHECK_FLOAT(0, 0x1.0000000000000p+55)
PASS_END
PASS_SETUP(float_round_down2, "72057594037927940.0", 64)
	CHECK_FLOAT(0, 0x1.0000000000000p+56)
PASS_END
PASS_SETUP(float_round_down3, "108086391056891908.0", 64)
	CHECK_FLOAT(0, 0x1.8000000000000p+56)
PASS_END
PASS_SETUP(float_round_down4, "144115188075855881.0", 64)
	CHECK_FLOAT(0, 0x1.0000000000000p+57)
PASS_END
PASS_SETUP(float_round_down5, "180143985094819849.0", 64)
	CHECK_FLOAT(0, 0x1.4000000000000p+57)
PASS_END
PASS_SETUP(float_round_down6, "216172782113783817.0", 64)
	CHECK_FLOAT(0, 0x1.8000000000000p+57)
PASS_END
PASS_SETUP(float_round_down7, "252201579132747785.0", 64)
	CHECK_FLOAT(0, 0x1.c000000000000p+57)
PASS_END
PASS_SETUP(float_round_down8, "288230376151711763.0", 64)
	CHECK_FLOAT(0, 0x1.0000000000000p+58)
PASS_END
PASS_SETUP(float_round_down9, "324259173170675731.0", 64)
	CHECK_FLOAT(0, 0x1.2000000000000p+58)
PASS_END

// Round up tests
PASS_SETUP(float_round_up1, "36028797018963974.0", 64)
	CHECK_FLOAT(0, 0x1.0000000000001p+55)
PASS_END
PASS_SETUP(float_round_up2, "72057594037927949.0", 64)
	CHECK_FLOAT(0, 0x1.0000000000001p+56)
PASS_END
PASS_SETUP(float_round_up3, "108086391056891917.0", 64)
	CHECK_FLOAT(0, 0x1.8000000000001p+56)
PASS_END
PASS_SETUP(float_round_up4, "144115188075855899.0", 64)
	CHECK_FLOAT(0, 0x1.0000000000001p+57)
PASS_END
PASS_SETUP(float_round_up5, "180143985094819867.0", 64)
	CHECK_FLOAT(0, 0x1.4000000000001p+57)
PASS_END
PASS_SETUP(float_round_up6, "216172782113783835.0", 64)
	CHECK_FLOAT(0, 0x1.8000000000001p+57)
PASS_END
PASS_SETUP(float_round_up7, "252201579132747803.0", 64)
	CHECK_FLOAT(0, 0x1.c000000000001p+57)
PASS_END
PASS_SETUP(float_round_up8, "288230376151711798.0", 64)
	CHECK_FLOAT(0, 0x1.0000000000001p+58)
PASS_END
...
PASS_SETUP(float_tie_down1, "18014398509481986", 64)
	CHECK_FLOAT_RELAXED(0x1.0000000000000p+54)
PASS_END
PASS_SETUP(float_tie_down2, "36028797018963972", 64)
	CHECK_FLOAT_RELAXED(0x1.0000000000000p+55)
PASS_END
PASS_SETUP(float_tie_down3, "54043195528445956", 64)
	CHECK_FLOAT_RELAXED(0x1.8000000000000p+55)
PASS_END
PASS_SETUP(float_tie_down4, "72057594037927944", 64)
	CHECK_FLOAT_RELAXED(0x1.0000000000000p+56)
PASS_END
PASS_SETUP(float_tie_down5, "90071992547409928.0", 64)
	CHECK_FLOAT_RELAXED(0x1.4000000000000p+56)
PASS_END
PASS_SETUP(float_tie_down6, "108086391056891912.0", 64)
	CHECK_FLOAT_RELAXED(0x1.8000000000000p+56)
PASS_END
PASS_SETUP(float_tie_down7, "126100789566373896.0", 64)
	CHECK_FLOAT_RELAXED(0x1.c000000000000p+56)
PASS_END
PASS_SETUP(float_tie_down8, "144115188075855888.0", 64)
	CHECK_FLOAT_RELAXED(0x1.0000000000000p+57)
PASS_END
PASS_SETUP(float_tie_down9, "162129586585337872.0", 64)
	CHECK_FLOAT_RELAXED(0x1.2000000000000p+57)
PASS_END

// Tie to even (up) tests
PASS_SETUP(float_tie_up1, "18014398509481990", 64)
	CHECK_FLOAT_RELAXED(0x1.0000000000002p+54)
PASS_END
PASS_SETUP(float_tie_up2, "36028797018963980", 64)
	CHECK_FLOAT_RELAXED(0x1.0000000000002p+55)
PASS_END
PASS_SETUP(float_tie_up3, "54043195528445964", 64)
	CHECK_FLOAT_RELAXED(0x1.8000000000002p+55)
PASS_END
PASS_SETUP(float_tie_up4, "72057594037927960", 64)
	CHECK_FLOAT_RELAXED(0x1.0000000000002p+56)
PASS_END
PASS_SETUP(float_tie_up5, "90071992547409944.0", 64)
	CHECK_FLOAT_RELAXED(0x1.4000000000002p+56)
PASS_END
PASS_SETUP(float_tie_up6, "108086391056891928.0", 64)
	CHECK_FLOAT_RELAXED(0x1.8000000000002p+56)
PASS_END
PASS_SETUP(float_tie_up7, "126100789566373912.0", 64)
	CHECK_FLOAT_RELAXED(0x1.c000000000002p+56)
PASS_END
PASS_SETUP(float_tie_up8, "144115188075855920.0", 64)
	CHECK_FLOAT_RELAXED(0x1.0000000000002p+57)
PASS_END
PASS_SETUP(float_tie_up9, "162129586585337904.0", 64)
	CHECK_FLOAT_RELAXED(0x1.2000000000002p+57)
PASS_END
...
static void test_ejflt_speed(const int niters, const char *name,
	...
	for (int i = 0; i < niters; i++) {
		for (int j = 0; j < strings_len; j++) {
			no_optimize += strtod(strings[j], NULL);
		}
	}
	time = (double)(clock() - start) / (double)CLOCKS_PER_SEC;
...
static const test_t tests[] = {
	...
	TEST_ADD(pass_float_round_down3)
	TEST_ADD(pass_float_round_down4)
	TEST_ADD(pass_float_round_down5)
	TEST_ADD(pass_float_round_down6)
	TEST_ADD(pass_float_round_down7)
	TEST_ADD(pass_float_round_down8)
	TEST_ADD(pass_float_round_down9)
	TEST_PAD
	TEST_ADD(pass_float_round_up1)
	TEST_ADD(pass_float_round_up2)
	TEST_ADD(pass_float_round_up3)
	TEST_ADD(pass_float_round_up4)
	TEST_ADD(pass_float_round_up5)
	TEST_ADD(pass_float_round_up6)
